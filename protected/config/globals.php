...
$portal_helper=MODULES_FOLDER . '/portal/components/portalHelper.php';
require_once($portal_helper);
...
{   
    if(isset(Yii::app()->session['translate']))
    {
        $category=Yii::app()->session['translate'];
    }
