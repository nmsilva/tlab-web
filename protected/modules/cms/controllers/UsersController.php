...
class UsersController extends Controller
{
	...
	{
                $this->pageTitle=t("Adicionar Utilizador");
		$model=new CMSUser;
	...
	{
                $this->pageTitle=t("Editar Utilizador");
		$model=$this->loadModel($id);
	...
	public function actionIndex()
	{
                ...
                $this->pageTitle=t("Lista de Utilizadores");
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cmsuser-form')
		{
